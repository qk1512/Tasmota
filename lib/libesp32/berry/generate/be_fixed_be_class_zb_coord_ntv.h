...
static be_define_const_map_slots(be_class_zb_coord_ntv_map) {
    ...
    { be_const_key_weak(size, 10), be_const_ctype_func(zc_size) },
    { be_const_key_weak(started, -1), be_const_func(zc_started) },
    ...
    { be_const_key_weak(find, -1), be_const_func(zc_find) },
